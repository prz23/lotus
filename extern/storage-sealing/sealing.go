...
type SealingAPI interface {
	...
	SendMsg(ctx context.Context, from, to address.Address, method abi.MethodNum, value, maxFee abi.TokenAmount, params []byte, secnum abi.SectorNumber) (cid.Cid, error)
